...
router.get('/settings', authMiddleware, userController.getSettingsHandler)
router.put('/settings', authMiddleware, userController.updateSettingsHandler)
...
router.get('/watch-history/continue', authMiddleware, userController.getContinueWatchingHandler)
