...
const leans = [20, -20, 18, -18]

export default function DynamicChevronBackdrop() {
          ...
          return (
            ...
            >
              <div
                ...
                style={{
                  opacity: 0,
                  animation: `fadeInOpacity 0.8s ease-out ${i * 0.15}s forwards`,
                }}
              >
                <div
                  className="absolute inset-0"
                  style={{
                    transform: `skewX(${skew}deg) scale(1.35)`,
